...
myMQTTClient.configureCredentials("/home/pi/cert/AmazonRootCA1.pem", "/home/pi/cert/bb4fb28ffc43c6311456fe212f95053d3238255f294dab7a1f4fcdde7f6a87a0-private.pem.key", "/home/pi/cert/bb4fb28ffc43c6311456fe212f95053d3238255f294dab7a1f4fcdde7f6a87a0-certificate.pem.crt")
...
def check_access_class(card):
    db = mysql.connector.connect(host="localhost", user="pi", password="Kongcf10300819", database="smart_classroom_system_db") 
...
myMQTTClient.subscribe("Rpi3/status", 1, on_message)
